<template>
  <svg :width="size" :height="size" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather-icon">
    ...
    <g v-else-if="name === 'power' || name === 'battery'">
    ...
    <g v-else-if="name === 'info' || name === 'about'">
    ...
    <g v-else-if="name === 'sliders' || name === 'tune'">
